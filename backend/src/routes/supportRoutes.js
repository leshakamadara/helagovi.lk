...
router.get('/tickets', protect, authorize('admin'), (req, res) => {
...
// Get specific ticket
router.get('/tickets/:id', protect, authorize('admin'), (req, res) => {
...
router.patch('/tickets/:id/status', protect, authorize('admin'), (req, res) => {
